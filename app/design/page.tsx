...
import DesignWidget, { defaultTemplate } from '../components/DesignWidget';
...
const defaultStyle: StyleProps = {
  ...
  title: { value: 'Nữ Phụ Muốn Ly hôn', template: defaultTemplate, family: 'Playball', color: '#e64980', size: 100, margin: { top: 0, left: 0 }, shadow: { enable: true, value: '#e64980' } },
